...
1. [Social Reel Maker](#1-social-reel-maker)
2. [Campaign Writer](#2-campaign-writer)
3. [Referral Builder](#3-referral-builder)
4. [GBP Optimizer](#4-gbp-optimizer)
5. [Review Responder](#5-review-responder)
6. [Competitor Scout](#6-competitor-scout)
7. [Local SEO Keyfinder](#7-local-seo-keyfinder)
...
**Step 2: Pick the Right Reel Format**
Match format to business type and goal:
...
Always suggest 3-5 ideas in one go so the owner can batch-film them in a single session.
...
**Step 3: Write the Email Campaign**
...
**Step 4: Write the SMS Version**
Keep under 160 characters for single SMS. Use urgency.
...
Rule of thumb: Reward should be 10-20% of average order value.
...
**Step 4: Create the Tracking System**
For businesses without fancy software:
...
**Step 1: Audit Current Profile Completeness**
Check every field — Google rewards 100% complete profiles.
...
Primary category is the MOST important ranking factor.
...
Formula for the 750-character description:
...
Google profiles with photos get 42% more requests for directions.
...
Posts show in search results and Maps. Post at least weekly.
...
Seed 5-10 common questions and answer them yourself.
...
Output as a ranked action list:
...
The gap analysis — what you can exploit:
...
**Step 3: Build the Keyword Table**
