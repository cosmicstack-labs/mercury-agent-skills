...
metadata:
  ...
  version: 1.0.0
  category: career
  tags: [career, planning, growth, development, goals]
license: MIT
metadata:
  hermes:
...
### Every 6 Months
1. List your top 5 technical skills (rate 1-10)
2. List top 5 soft skills (rate 1-10)
3. Identify 2 skills to grow next quarter
4. Check job descriptions for target role — what's missing?
5. Create a learning plan with specific milestones
...
2. Build portfolio projects in new domain
3. Network with people in target field
4. Get certification or targeted education
5. Start with adjacent role, then pivot fully
